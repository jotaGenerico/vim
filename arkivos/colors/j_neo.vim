...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Identifier ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    ...
    hi StatusLine ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    hi StatusLineNC ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    hi VertSplit ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#d7d4cd gui=NONE
    hi TabLine ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    hi TabLineFill ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#d7d4cd gui=NONE
    hi TabLineSel ctermbg=98 ctermfg=232 cterm=NONE guibg=#C678DD guifg=#121212 gui=NONE
    hi Title ctermbg=98 ctermfg=232 cterm=NONE guibg=#C678DD guifg=#121212 gui=NONE
    hi CursorLine ctermbg=232 ctermfg=NONE cterm=NONE guibg=#111111 guifg=NONE gui=NONE
    hi LineNr ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    ...
    hi Visual ctermbg=NONE ctermfg=98 cterm=reverse guibg=NONE guifg=#C678DD gui=reverse
    ...
    hi Folded ctermbg=98 ctermfg=232 cterm=NONE guibg=#C678DD guifg=#121212 gui=NONE
    hi WildMenu ctermbg=98 ctermfg=232 cterm=NONE guibg=#C678DD guifg=#121212 gui=NONE
    ...
    hi Directory ctermbg=NONE ctermfg=98 cterm=NONE guibg=NONE guifg=#C678DD gui=NONE
    ...
    hi ModeMsg ctermbg=98 ctermfg=232 cterm=NONE guibg=#C678DD guifg=#121212 gui=NONE
