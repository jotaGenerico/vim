" Vim color file
" krust
" Created by jota with ThemeCreator (https://github.com/mswift42/themecreator)
...
exe 'hi Normal guifg='s:fg' guibg='s:bg' ctermbg=NONE'
